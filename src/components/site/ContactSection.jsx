      ...
      <div className="max-w-4xl mx-auto px-6">
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-16 lg:gap-24">
          ...
          <div className="lg:col-span-2">
            ...
            >
              <a href="mailto:hello@atlasandarc.com" className="flex items-center gap-3 text-[#a09888] hover:text-[#c9a96e] transition-colors duration-300 text-sm font-light">
                <Mail className="w-4 h-4" />
                hello@atlasandarc.com
              </a>
              <a href="https://instagram.com/atlasandarc" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 text-[#a09888] hover:text-[#c9a96e] transition-colors duration-300 text-sm font-light">
